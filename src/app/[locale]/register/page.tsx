    ...
    <div className="min-h-screen bg-slate-50 flex flex-col">
      <nav className="bg-white border-b border-slate-100 shadow-sm">
        <div className="max-w-7xl mx-auto px-6 flex h-16 items-center justify-between">
          ...
          <a href={`/${locale}/login`} className="text-sm font-semibold text-slate-500 hover:text-blue-700 transition-colors">
            {t("hasAccount")}{" "}
            <span className="text-blue-700">{t("loginLink")}</span>
          </a>
        </div>
      </nav>
        ...
        <div className="w-full max-w-md">
          <div className="bg-white rounded-3xl shadow-xl border border-slate-100 overflow-hidden">
            <div className="bg-blue-700 px-8 py-8">
              <h1 className="text-2xl font-extrabold text-white">{t("register")}</h1>
              <p className="text-blue-200 text-sm mt-1">{t("registerDesc")}</p>
            </div>
            <div className="p-8">
